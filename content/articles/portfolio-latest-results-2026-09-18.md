...
date: "2026-09-18"
summary: "刷新至 9 月 18 日的 25 个持仓结构，完整纳入新增 A 股与境内 ETF，并更新本周正式披露、组合集中度和风险因子。"
tags:
  - 组合复盘
  - 财报分析
  - 风险管理
...
数据截点：2026-09-18 14:29 UTC

> 本报告基于 mengshi.de `/api/data` 返回的 **25 个资产**。网站展示的 `allocationInPercentage` 合计为 109.30%，并非标准的 100% 净资产权重，可能涉及账户范围、杠杆或数据归一化口径。因此，下文的“网站配置”仅用于比较持仓重要性，不据此推算精确组合收益或风险贡献。
>
> 个股使用截至数据截点已经正式发布的最新完整季报。基金和 ETF 不发布企业财报，改用最新基金组合、净值、费用和结构披露。本文是研究记录，不构成个性化投资建议。

## 最新网站快照

- `/api/data` 当前返回 **25 个证券持仓**、4 个货币敞口和 273 个组合表现数据点；最新表现日期为 2026-09-18。Portfolio breadth 与线上卡片一致为 25。
- 相比 9 月 12 日版，PFE 不再出现；新增 000333.SZ、300750.SZ、516080.SS、518850.SS、563020.SS、563360.SS、600900.SS 和 688008.SS，净增 7 个至 25 个。新增的 8 个境内标的合计网站配置 44.54%，其中黄金 ETF 8.17%，其余 A 股与股票 ETF 36.37%。
- 由于账户范围和持仓集合已经变化，旧版快照与新版历史序列不能直接做组合归因。本次冻结序列把 9 月 12 日净表现回填为 28.69%，至 9 月 18 日为 28.40%，回落约 0.29 个百分点；9 月 16 日一度降至 26.73%。
- 最大单一网站配置仍是 GOOGL 14.74%，VOO 为 12.12%；其后依次为黄金 ETF 8.17%、长江电力 7.97%、宁德时代 6.97% 和美的集团 6.71%。GOOGL、NVDA、AMZN 三只直持合计 20.68%，较旧快照明显降低，但仍是重要共同因子。
- 货币敞口已由美元绝对主导转为双核心：USD 46.56%、CNY 44.54%、EUR 5.45%、GBp 3.46%。这提高了地域和资产类别分散，同时新增人民币、A 股风格、境内政策及黄金价格风险。

## 9 月 13 日–9 月 18 日正式披露增量

- **新增 A 股与境内 ETF：** 8 个新标的均按最新公开资料建立基线。美的、宁德时代、长江电力和澜起科技采用 2026 年半年报；创新药、红利低波、A500 和黄金 ETF 采用管理人 2026 年中期/二季度披露。澜起科技 9 月 17 日另披露限制性股票部分归属结果，属于股本事项，不改变半年报经营结论。
- **AstraZeneca：** 9 月 14 日公布 SERENA-4 III 期未达到 PFS 显著改善的主要终点，仅观察到数值改善。这不推翻已基于 SERENA-6 获批的 ESR1 突变动态监测用法，却削弱了 Etcamah 在未经筛选的一线广泛人群中的扩张证据。9 月 14 日董事长购入 2,500 股、9 月 18 日披露 CEO 购入 60,000 股，属于管理层交易，不能替代临床数据。
- **GSK：** 9 月 13 日披露 Ris-Rez 在中国复发小细胞肺癌 III 期把死亡风险相对 topotecan 降低 54%，中位 OS 为 18.5 对 10.3 个月；9 月 14 日 Jideytro 一线 ROS1 阳性 NSCLC 注册性研究 ORR 为 94%，12 个月 PFS 率为 90%，但仍是单臂 I/II 期。9 月 15 日又从 Chimagen 获得一个计划 2027 年进入 I 期的三特异 TCE 全球权利，潜在总对价最高 7.5 亿美元，前期付款未披露。
- **Amazon 与 NextEra：** Amazon 于 9 月 14 日完成 42.5 亿英镑四档债券发行，实际预计净募资约 42.35 亿英镑；这把前版“拟交付”转为已完成融资。NextEra 同日为拟并购 Dominion 提出增强版 Virginia 利益方案，包括把居民每月 10 美元账单抵扣由两年延长至四年、到 2038 年增加 1 亿美元低收入援助和新增 1,000 个直接岗位；方案有助于监管沟通，但仍不等于交易获批。
- **其余持仓：** 已核对 SEC 与交易所增量披露；除例行内部人、基金持仓及股本事项外，未出现新的完整财报。最新经营判断仍以各自 Q2/H1 或最新基金报告为基准。

## 一、组合结论

### 最重要的五个判断

1. **组合已从美元成长股主导，转为 USD/CNY 双核心。** CNY 敞口 44.54%；按网站配置近似拆分，四只 A 股直持约 25.3%、三只股票 ETF 约 11.1%、黄金 ETF 8.17%。地域分散提高，但 A 股政策、人民币和境内风格因子已成为与美国大型科技同等级的重要风险源。
2. **黄金是新的第三大仓位，不是普通股票分散。** 518850.SS 网站配置 8.17%，主要跟踪上海金 Au99.99；它能缓冲部分信用、通胀和地缘风险，却会受到实际利率、美元/人民币、境内外价差与跟踪误差影响。短期收益 -1.68% 说明避险资产也会回撤。
...
4. **科技集中度下降但没有消失。** GOOGL、NVDA、AMZN 直持合计 20.68%，VOO 仍有 12.12%，SMT.L、A500 和 VXUS 继续带来间接科技敞口。按 VOO 7 月底权重近似穿透，Alphabet、NVIDIA、Amazon 的网站口径敞口约为 15.45%、4.68% 和 2.67%。
5. **报告期利润质量分化明显。** 美的扣非利润同比 -25.31% 主要受汇率损失计入经常损益、对冲收益计入非经常损益的会计分类影响；澜起归母净利润 +72.33%，但扣非仅 +21.17%，公允价值与投资收益贡献较大。宁德与长江电力的扣非增长分别约 43.44% 和 8.37%，更接近主业趋势。

### 组合优先级

- **经营质量较强但估值/资本回报要求高：** GOOGL、NVDA、AMZN、宁德时代、澜起科技、ENR.DE、MA。
- **现金流或防御属性更清晰：** 长江电力、美的集团、红利低波 ETF、黄金 ETF、VOO、VXUS。
- **经营改善或结构性成长需继续验证：** LR.PA、AZN、GSK、NEE、NRG、TLN、创新药 ETF、A500 ETF。
- **市场与主题波动最高：** COIN、URA、SMT.L；黄金的驱动不同，但 8.17% 仓位也会显著影响组合波动。
- **组合结构风险：** ETF 与直持存在多层重叠；网站权重合计 109.30%，所有穿透结果只能作结构近似，不能当作标准净资产风险贡献。

## 二、逐项分析

## 000333.SZ - 美的集团

- **网站配置：** 6.71%；网站收益表现：+27.89%。
...
- **核心判断：** 家电主业低个位数增长、楼宇与机器人更快，经营现金流覆盖利润；但毛利率略降、工业技术收缩和汇率会计错配需要持续观察。6.71% 的网站配置使美的成为重要的人民币制造业与消费敞口。
- **来源：** [美的集团 2026 年半年度报告](https://static.cninfo.com.cn/finalpage/2026-08-29/1225531404.PDF)

## 300750.SZ - 宁德时代

- **网站配置：** 6.97%；网站收益表现：+55.54%。
...
- **网站配置：** 8.17%；网站收益表现：-1.68%，为当前第三大网站配置。
...
- **核心判断：** 黄金与企业盈利关联较低，能提供危机、通胀及货币信用分散，但短期仍受实际利率、美元、人民币汇率、境内外金价溢价和跟踪误差影响。8.17% 的仓位足以显著改变组合波动，不应把“避险”理解成不会亏损。
...
- **核心判断：** A500 提供较广的 A 股核心资产覆盖，但当前制造业和 AI 硬件权重并不低，并会与直持宁德时代、澜起科技形成一定重叠。1.62% 的网站配置限制了重叠量级，却不能把它当作纯粹防御仓。
- **来源：** [华泰柏瑞 563360 官方产品页](https://www.huatai-pb.com/products/zhishu/563360/index.html)

## 600900.SS - 长江电力

- **网站配置：** 7.97%；网站收益表现：+16.22%，为当前第四大网站配置。
...
- **网站配置：** 3.63%；网站收益表现：+106.03%，为 25 个持仓中最高。
- **最新完整财报：** 2026 H1，报告期截至 2026-06-30；半年报于 2026-08-29 披露。
...
- **核心判断：** 内存接口与互连芯片受益于服务器升级和 AI 基础设施需求，经营增长真实；但净利润增速被非经营收益放大，且 +106.03% 的网站收益提示估值和预期风险已经上升。9 月 17 日限制性股票部分归属属于股本稀释观察项，不改变半年报主业结论。
- **来源：** [澜起科技 2026 年半年度报告](https://www.sse.com.cn/disclosure/listedinfo/announcement/c/new/2026-08-29/688008_20260829_JHDD.pdf)

## AMZN - Amazon

- **网站配置：** 2.17%；网站收益表现：+67.27%。
...
- **核心判断：** AWS 明显加速、零售利润改善，经营动能较 Q1 更强；组合对 AMZN 的网站配置为 2.17%，按 VOO 7 月底持仓估算还带来约 0.50% 的间接网站口径敞口。Globalstar 交易、AI 资本开支与新增长期融资要求更严格地检验资本配置回报。
...
- **结论：** 经营增长与全年指引稳健，但 SERENA-4 失败显示同一资产在不同治疗策略下证据可明显分化；仍应把核心 EPS、现金转化、许可成本和管线成功率一起评估。2.86% 的网站配置限制了单一临床事件的组合冲击。
...
- **结论：** 网站收益表现为 -39.88%，Q2 基本面尚未改善。COIN 的网站配置为 3.26%，仍是组合中周期性、会计波动和盈利可见性风险最重要的单一持仓之一。
...
- **结论：** 基本面已从“指引上修”进入“订单、利润、现金流同步兑现”阶段，但当前估值也要求公司顺利实现甚至部分超越 FY2028 目标；网站收益为 -11.41%，显示持仓时点和高预期定价会放大波动。
...
- **核心判断：** 广告、云和 AI 商业化推动强劲经营增长，营业利润增速快于收入，是高质量信号。但组合对 Alphabet 的直接配置约 14.74%，加上 VOO 7 月底 Alphabet A/C 合计约 5.86% 的基金权重，网站口径穿透敞口约 15.45%，单一公司集中度仍高。
...
- **结论：** 最新上半年财报支持“结构性增长加利润率韧性”的投资逻辑；2.67% 的网站配置仍提供可见的电力与数据中心基础设施敞口。
...
- **核心判断：** 全球支付网络、跨境恢复与增值服务组成高质量复利模型；主要约束是客户激励上升、支付监管、消费者支出与跨境旅行周期。0.97% 的网站配置提高业务模式分散，但现阶段对组合贡献有限。
...
- **结论：** 当前组合中经营动能最强的公司之一；按 VOO 7 月底持仓穿透，直持加 VOO 的网站口径敞口约 4.68%。后续除订单、DSO、库存、客户集中和承诺取消条款外，还应跟踪 Hugging Face 审批、员工留任和开放平台承诺的执行。
...
- **网站配置：** 3.46%；网站收益表现：+29.83%。
- **最新基金披露：** 关键资料截至 2026-08-31；配对收盘价与 NAV 更新至 2026-09-10，另有 9 月 11 日盘中报价。
- **关键数字：** 总资产约 177.49 亿英镑，股东资金约 171.41 亿英镑，Active Share 为 87%；持续费用率 0.33%（截至 3 月 31 日）。9 月 10 日收盘价 1,473.50 便士、公允 NAV 1,606.64 便士，折价约 8.3%；9 月 11 日 15:30 GMT 单独报价为 1,477.25 便士，不与前一日 NAV 混算新折价。
...
- **结论：** 不能用单家公司财报框架分析。它是高 beta 主题仓，2.87% 的网站配置仍足以显著影响组合波动。
...
- **穿透估算：** 以本次 VOO 网站配置乘 7 月底基金权重，额外贡献约 NVDA 0.92%、AMZN 0.50%、Alphabet 0.71% 的网站口径敞口；直持加 VOO 后三者分别约为 4.68%、2.67% 和 15.45%。这是跨日期的结构近似，尚未计入 SMT.L、A500 或其他基金中的重复持仓，也不是标准净资产权重。
...
- **网站配置：** 3.67%；网站收益表现：+1.72%。
- **最新基金披露：** 持仓和特征截至 2026-07-31，资产规模及回报截至 2026-08-31，价格与 NAV 更新至 2026-09-10；当天 NAV 为 86.32 美元，市场价 86.28 美元。
...
| 风险 | 主要相关持仓 | 判断 |
|---|---|---|
| 大型科技、AI 与服务器资本开支 | GOOGL、NVDA、AMZN、澜起科技、VOO、A500、SMT.L、VXUS | 组合第一大共同因子仍在；收入增长强，但估值、资本回报、客户投入和硬件周期可能同步反转。 |
| 非经营收益与会计分类 | GOOGL、NVDA、AMZN、澜起科技、美的、长江电力 | 投资、公允价值、汇兑与对冲分类会放大或扭曲净利润；需结合营业利润、扣非口径与现金流。 |
| A 股政策、行业与风格 | 美的、宁德时代、长江电力、澜起科技、创新药 ETF、红利低波 ETF、A500 ETF | CNY 敞口已达 44.54%；产业政策、集采、监管、流动性和成长/红利轮动可能同时影响多个持仓。 |
| 黄金、实际利率与汇率 | 华夏黄金 ETF | 8.17% 配置能分散企业盈利风险，但实际利率、美元、人民币和境内溢价可能造成显著回撤。 |
| 电力、水文与商品价格 | 长江电力、NRG、TLN、URA、ENR.DE、LR.PA | 来水、铀价、电价、天然气价和容量价格会直接改变利润或估值；各标的驱动不同，不能简单合并为一个低波动主题。 |
...
| 利率、融资和或有承诺 | NVDA、NEE、NRG、TLN、GOOGL、AMZN、SMT.L、AZN、长江电力 | 高资本开支、并购债务或杠杆使利率敏感度上升；Amazon 融资已完成，NVIDIA 另有大额承诺、AI 云/租赁协议和担保。 |
...
| 外汇 | 美的、宁德时代、ENR.DE、LR.PA、GSK、SMT.L、VXUS、AZN、MA、AMZN | USD/CNY 已接近双核心；跨国经营、外币融资和人民币变化会同时影响折算、竞争力与会计损益。 |
...
- 持仓和网站配置：[mengshi.de 公开 API](https://www.mengshi.de/api/data)，2026-09-18 14:29 UTC 冻结读取；账户范围沿用线上快照，不与本地开发环境数据混用。
...
- 境外基金：Vanguard、Avantis、Global X、Scottish Mortgage/Baillie Gifford 官方页面和完整持仓文件。
