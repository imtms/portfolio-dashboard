...
export default function ArticleNavbar({ darkMode, onTheme }) {
  return (
    <header className={styles.topbar}>
      <div className={styles.topbarInner}>
        ...
        <nav className={styles.productNav} aria-label="Product navigation">
          ...
          <Link className={styles.activeNav} href="/articles">Articles</Link>
        </nav>
        <button type="button" onClick={onTheme} className={styles.iconButton} aria-label={darkMode ? "Use light theme" : "Use dark theme"}>
